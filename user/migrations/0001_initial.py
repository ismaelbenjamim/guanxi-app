# Generated by Django 4.2 on 2025-02-21 21:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_user_id', models.CharField(blank=True, max_length=200, null=True)),
                ('session_id', models.CharField(blank=True, max_length=200, null=True)),
                ('session_data', models.FileField(blank=True, null=True, upload_to='sessions/')),
                ('temp_code', models.CharField(blank=True, max_length=10, null=True)),
                ('status', models.CharField(choices=[('PENDING', 'Pendente'), ('PROCESSING_ERROR', 'Falha no processamento'), ('PROCESSING', 'Processando'), ('WAITING_CODE', 'Aguardando código de autenticação'), ('CONFIRMED', 'Conta Confirmada')], default='PENDING', max_length=20)),
